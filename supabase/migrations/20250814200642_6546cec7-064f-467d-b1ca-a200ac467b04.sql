...
-- Insert sample courses for language learning
INSERT INTO public.courses (title, description, instructor_id, category, level, duration_hours, price, is_published) VALUES
('Spanish for Beginners', 'Learn basic Spanish conversation, grammar, and vocabulary', (SELECT id FROM auth.users LIMIT 1), 'language', 'beginner', 20, 49.99, true),
('French Conversation Mastery', 'Master French speaking and listening skills', (SELECT id FROM auth.users LIMIT 1), 'language', 'intermediate', 30, 79.99, true),
('Japanese Writing System', 'Learn Hiragana, Katakana, and basic Kanji', (SELECT id FROM auth.users LIMIT 1), 'language', 'beginner', 25, 59.99, true),
('German Grammar Fundamentals', 'Complete guide to German grammar and sentence structure', (SELECT id FROM auth.users LIMIT 1), 'language', 'intermediate', 35, 89.99, true);